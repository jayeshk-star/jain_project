...
const packages = [
  {
    image:
      "https://images.pexels.com/photos/2748019/pexels-photo-2748019.jpeg?auto=compress&cs=tinysrgb&w=600",
    title: "Italy",
  ...
  {
    image:
      "https://images.pexels.com/photos/707677/pexels-photo-707677.jpeg?auto=compress&cs=tinysrgb&w=600",
    title: "Japan",
  ...
  {
    image:
      "https://images.pexels.com/photos/94420/pexels-photo-94420.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    title: "Malaysia",
  ...
  {
    image:
      "https://images.pexels.com/photos/2915957/pexels-photo-2915957.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    title: "China",
...
const services = [
  {
    ...
    description:
      "Booking and reservation services for hotels, resorts, lodges, and vacation rentals",
  },
  {
    name: "Food & Drinks",
    description:
      "Engage travelers in interactive and educational experiences related to food and beverages",
  },
  {
    name: "Safety Guide",
  ...
  },
  {
    ...
    description:
      "Offer travel insurance options to ensure travelers' safety and security during their trips",
  },
  {
    name: "Transportation Assistance",
    description:
      "Arrangement of airport transfers, car rentals, and transportation between destinations",
  },
  {
    name: "Wellness & Spa",
...
const gallarySection = document.getElementById("gallary-section");
...
function handleFormSubmit(e) {
  ...
  if (
    ...
    isValid &= validateEndDateAfterStartDate(
      endDate.value,
      startDate.value,
      endDateError,
      "Error: End Date cannot be prior to Start Date."
    );
    isValid &= validateDescriptionLength(
      description.value,
      descriptionError,
...
function createGallary() {
  packages.map((package) => {
    let gallaryCard = document.createElement("div");
    let gallaryCardContent = document.createElement("div");
    let image = document.createElement("img");

    image.src = package.image;
    image.alt = package.title;

    gallaryCard.classList.add("gallary-card");
    gallaryCardContent.classList.add("card-content");

    gallaryCard.appendChild(image);
    gallaryCard.appendChild(gallaryCardContent);
    gallarySection.appendChild(gallaryCard);
  });
}
